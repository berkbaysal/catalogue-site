    ...
    return (
        <div className="ableton-style">
            <footer className="ableton-style-footer">
                <div className="footer-cell footer-company-name">{companyName}</div>
                    ...
                    <ul className="social-media-list">
                        ...
                        <li className="social-media-icons">
                            <div className="social-media-icon-container">
                                <a href="#"><FontAwesomeIcon icon={faSquareFacebook} className="social-media-icon" /></a>
                                <a href="#"><FontAwesomeIcon icon={faSquareTwitter} className="social-media-icon" /></a>
                                <a href="#"><FontAwesomeIcon icon={faSquareYoutube} className="social-media-icon" /></a>
                                <a href="#"><FontAwesomeIcon icon={faSquareInstagram} className="social-media-icon" /></a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div className="footer-cell footer-slogan-logo">
                    ...
                    {logo && <img src={logo} alt="" className="footer-logo" />}
